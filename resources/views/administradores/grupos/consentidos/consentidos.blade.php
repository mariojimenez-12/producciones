    ...
    <tbody class="text-center">
        ...
        @foreach( $consentido as $grupo )
            <tr>
                ...
                <td>
                    <eliminar-consentidos
                            articulo-id="{{ $grupo->id }}"
                        ></eliminar-consentidos>
                    <a class="btn btn-warning" href="{{ action('ConsentidoController@edit', ['consentido' => $grupo->id]) }}">Actualizar</a>
                </td>
            </tr>
        @endforeach
